...
## Chinese character translator for IDA Pro
...
The plugin tries to bind to Ctrl+R.
...
IDA's custom instruction capability is used to change the displayed bytes to UTF8 and can be manually reverted.
